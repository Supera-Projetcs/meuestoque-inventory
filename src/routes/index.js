...
const { getAllInventorys, createInventory, updateInventory, deleteInventory, getInventoryById,updateInventoryQuantities,getInventoryByIds, getTotalInventoryCount } = require('../controllers/inventoryController');
...
router.get('/inventorys/count', getTotalInventoryCount);
